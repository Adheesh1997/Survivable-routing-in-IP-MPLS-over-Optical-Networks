        ...
        //for(int pp = 0; pp < listOfEvents.size(); pp++)
        {
            ...
            */
            ...
            /*if (eventCounter % 10000 == 0)
            {
                ...
                cout << "establishedLSPcounter = " << establishedLSPcounter << endl;
                cout << "releasedLSPcounter = " << releasedLSPcounter << endl;
                
                myfile.writeLog("eventCounter = " + to_string(eventCounter));
                myfile.writeLog("actiontrueCounter = " + to_string(actiontrueCounter));
                myfile.writeLog("establishedLSPcounter = " + to_string(establishedLSPcounter));
                myfile.writeLog("rejectedLSPcounter = " + to_string(rejectedLSPcounter));
                myfile.writeLog("releasedLSPcounter = " + to_string(releasedLSPcounter));
                myfile.writeLog("");

                establishedLSPcounter = 0;
                releasedLSPcounter = 0;
                rejectedLSPcounter = 0;
                actiontrueCounter = 0;
            }*/
            if(action)
            {
