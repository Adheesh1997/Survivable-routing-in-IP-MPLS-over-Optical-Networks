...
=======
	void deleteLpLink(long int, int ,int, int);		// this can be used to  remove item from wavelengthAndLSP vector
...
public:
	...
	/*********************************************/
	void releaseEshtablishedLighpath(int, int, long int ,int );	// remove item from lightpath vector
